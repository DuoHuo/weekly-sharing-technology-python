...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'social_work', 'content', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Work.content'
        db.alter_column(u'social_work', 'content', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

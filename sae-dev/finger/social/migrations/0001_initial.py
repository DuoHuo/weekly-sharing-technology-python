...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserEx'
        db.create_table(u'social_userex', (
            ...
            ('icon', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ...
            ('qq', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('open_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal(u'social', ['UserEx'])


    def backwards(self, orm):
        # Deleting model 'UserEx'
        db.delete_table(u'social_userex')
    ...
    models = {
        ...
        u'social.userex': {
            ...
            'open_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30','blank':'True', 'null':'True'}),

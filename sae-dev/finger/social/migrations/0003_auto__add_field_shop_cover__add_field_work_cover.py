...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.cover'
        db.add_column(u'social_shop', 'cover',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Work.cover'
        db.add_column(u'social_work', 'cover',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shop.cover'
        db.delete_column(u'social_shop', 'cover')

        # Deleting field 'Work.cover'
        db.delete_column(u'social_work', 'cover')

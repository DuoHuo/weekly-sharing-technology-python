...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Advertise.content'
        db.alter_column(u'social_advertise', 'content', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Adding field 'Work.content'
        db.add_column(u'social_work', 'content',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Advertise.content'
        db.alter_column(u'social_advertise', 'content', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Deleting field 'Work.content'
        db.delete_column(u'social_work', 'content')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdvertiseCategory'
        db.create_table(u'social_advertisecategory', (
        ...
        db.send_create_signal(u'social', ['AdvertiseCategory'])

        # Adding model 'Advertise'
        db.create_table(u'social_advertise', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['social.AdvertiseCategory'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal(u'social', ['Advertise'])

        # Adding field 'UserEx.school'
        db.add_column(u'social_userex', 'school',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AdvertiseCategory'
        db.delete_table(u'social_advertisecategory')

        # Deleting model 'Advertise'
        db.delete_table(u'social_advertise')

        # Deleting field 'UserEx.school'
        db.delete_column(u'social_userex', 'school')
    ...
    models = {
        ...
        u'social.advertise': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['social.AdvertiseCategory']", 'null': 'True', 'blank': 'True'})
        },
        u'social.advertisecategory': {
            'Meta': {'object_name': 'AdvertiseCategory'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),

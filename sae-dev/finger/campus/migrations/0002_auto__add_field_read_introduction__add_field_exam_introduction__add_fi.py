...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Read.introduction'
        db.add_column(u'campus_read', 'introduction',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exam.introduction'
        db.add_column(u'campus_exam', 'introduction',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.introduction'
        db.add_column(u'campus_activity', 'introduction',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Read.introduction'
        db.delete_column(u'campus_read', 'introduction')

        # Deleting field 'Exam.introduction'
        db.delete_column(u'campus_exam', 'introduction')

        # Deleting field 'Activity.introduction'
        db.delete_column(u'campus_activity', 'introduction')
